...
<div class="rgt" style="">
        ...
        phoneID=session.getAttribute("phoneID").toString();
        ...
        <div id="reg1" class="tab-pane">
            <form id="verification" type="post" action="verification" onsubmit="return check1();" style="position:absolute;top: 95px;left: 100px; width: 600px;">
                <div style="margin-left: 30%;">
                     <input id="phoneID" name="phoneID" type="text" size="20" placeholder="<%=phoneID %>" style="text-indent: 1em;font-size: 16px;height: 40px;width: 370px;margin: 15px auto;" autofocus="autofocus" required="required" pattern="[0-9]{11}">
                    <small id="error1" style="color:#991411;position: absolute;text-align: left;right:40%;top:18%;"></small>
                    <input id="password" name="password" type="password" size="20" placeholder="<%=password %>" value="<%=password %>" style="text-indent: 1em;font-size: 16px;height: 40px;width: 370px;margin: 15px auto;" required="required">
                    <small id="error2" style="color:#991411;position: absolute;text-align: left;right:47%;top:39%;"></small>

                    <div style="margin: 15px 18px;display: inline-block;">
                        
	                        <img  style="float: left;width: 100px;height: 40px;margin: 3px 50px;" id="imagecode"  src="picture">
	                        <a href="javascript:reloadCode();">看不清楚</a>
	    					
	    					<input name="verification"id="yanzhengma" type="text" size="20" placeholder="验证码" style="text-indent: 1em;font-size: 16px;width: 170px;float: left;height: 40px;" required="required">
	    					
                    </div><br>
                    <small id="error3" style="color:#991411;position: absolute;text-align: left;right:48.5%;top:60%;"></small>
                    ...
                    <input type="submit" class="reg_bt" height="40px" value="注册" >
        ...
        <div id="reg2" class="tab-pane active" style="text-align: left;">
            <div class="details_right" style="margin: auto 230px;font-size: 15px;">
                ...
                function postData(){
                    ...
                    var yanzheng ="<%=ltx%>";
                    if(yanzheng!="true"){
                        document.getElementById("error3").innerHTML="请输入正确的验证码";
                    }
